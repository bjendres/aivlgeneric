 ...
 */
class CRM_Aivlgeneric_Upgrader_Base {

  /**
   * @var CRM_Aivlgeneric_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Aivlgeneric_Upgrader(
        'aivlgeneric',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Aivlgeneric_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Aivlgeneric_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
